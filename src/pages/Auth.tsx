      ...
      <div className="relative min-h-screen flex items-center justify-center p-6">
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden lg:block space-y-8 animate-fade-in">
            ...
            <div>
              ...
              <p className="text-xl text-muted-foreground leading-relaxed mb-8">
                A plataforma mais avançada para gestão inteligente de
                propriedades rurais
              </p>
              ...
              <div className="space-y-4">
                {[
                  {
                    icon: Shield,
                    text: "Segurança empresarial com criptografia de ponta",
                  },
                  {
                    icon: BarChart3,
                    text: "Análises em tempo real e relatórios avançados",
                  },
                  {
                    icon: Users,
                    text: "Suporte dedicado 24/7 para sua operação",
                  },
                ].map((item, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 p-4 rounded-xl bg-muted/30 backdrop-blur-sm border border-border/50 hover:scale-105 transition-transform"
                ...
                <div className="flex items-center gap-4 mb-4">
                  <div className="flex -space-x-2">
                    {[1, 2, 3, 4].map((i) => (
                      <div
                        key={i}
                        className="w-10 h-10 rounded-full gradient-primary border-2 border-background"
                      ></div>
                    ))}
                  </div>
                  <div>
          ...
          <div className="w-full max-w-md mx-auto animate-scale-in">
            <Link
              to="/"
              className="lg:hidden flex items-center text-primary hover:text-primary-dark mb-6 transition-colors"
            >
