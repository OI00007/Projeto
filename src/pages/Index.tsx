...
const automationFeature = new URL(
  "@/assets/automation-feature.jpg",
  import.meta.url,
).href;
...
const Index = () => {
  ...
  const stats = [
    {
      ...
      icon: Users,
      ariaLabel: "Mais de 10 mil produtores ativos",
    },
    {
      value: "95%",
      label: "Satisfação",
    ...
    },
    {
      ...
      icon: TrendingUp,
      ariaLabel: "40 porcento de aumento de produtividade",
    },
    {
      value: "24/7",
      label: "Monitoramento",
      icon: Shield,
      ariaLabel: "Monitoramento 24 horas por dia, 7 dias por semana",
    },
  ];
  ...
  const features = [
    {
      ...
      description:
        "Sistema avançado de previsão do tempo com alertas em tempo real para proteger sua produção.",
    },
    {
      icon: BarChart3,
      title: "Análise de Dados",
      description:
        "Dashboards interativos com métricas detalhadas e insights acionáveis sobre sua fazenda.",
    },
    {
      icon: Cpu,
      title: "Automação Inteligente",
      description:
        "IoT e IA para automatizar irrigação, controle de pragas e otimizar recursos.",
    },
    {
      icon: Shield,
      title: "Gestão Completa",
      description:
        "Controle financeiro, estoque, equipamentos e equipes em uma plataforma única.",
    },
  ];
  ...
  const storyHighlights = [
    {
      title: "Missão",
      description:
        "Conectar a agricultura brasileira a decisões inteligentes com tecnologia acessível e sustentável.",
      icon: Leaf,
    ...
    },
    {
      title: "Visão",
      description:
        "Ser referência em gestão rural, ajudando cada produtor a prosperar com segurança e eficiência.",
      icon: TrendingUp,
    ...
    },
    {
      title: "Valores",
      description:
        "Inovação, confiança e resultados claros para o campo e a comunidade rural.",
      icon: Users,
  ...
  const testimonials = [
    {
      quote:
        "O sistema revolucionou a gestão da nossa fazenda. Conseguimos aumentar a produtividade em 45% no primeiro ano.",
      author: "João Silva",
    ...
    {
      quote:
        "A automação inteligente nos permitiu reduzir custos com água em 38% e ter muito mais controle sobre nossa produção.",
      author: "Maria Santos",
  ...
  return (
    <>
      ...
      >
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-24 w-full">
            <div className="max-w-3xl">
              ...
              >
                Fazenda
                <span
                  className="block text-accent entrance-slide-up"
              ...
              <p
                className="text-xl sm:text-2xl text-white/85 mb-12 leading-relaxed max-w-2xl entrance-fade"
                style={{ animationDelay: "0.5s" }}
              >
                Revolucione sua propriedade rural com tecnologia de ponta.
                Monitore, analise e otimize sua produção em tempo real com IA e
                IoT.
              </p>

              <div
                className="flex flex-col sm:flex-row gap-4 entrance-scale"
              ...
              >
                ...
                >
                  <Play
                    className="w-6 h-6 mr-2 transition-all duration-500 group-hover:scale-110"
                    aria-hidden="true"
                  />
                  Ver Dashboard
                  <ArrowRight
                    className="w-5 h-5 ml-2 transition-all duration-500 group-hover:translate-x-2"
                    aria-hidden="true"
                  />
                </Button>
                <Button
            ...
            >
              {stats.map((stat, index) => {
                ...
                return (
                  ...
                  >
                    <Icon
                      className="w-7 h-7 sm:w-8 sm:h-8 text-white/90 mx-auto mb-3 group-hover:scale-125 group-hover:text-accent transition-all duration-500"
                      aria-hidden="true"
                    />
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <header className="text-center mb-16 sm:mb-20">
              ...
              <p
                className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed entrance-fade"
                style={{ animationDelay: "0.2s" }}
              >
                Ferramentas completas para gestão inteligente da sua propriedade
                rural
              </p>
            </header>
        ...
        {/* About Argom Section */}
        <section
          className="py-24 sm:py-28 bg-gradient-to-br from-muted/80 via-background to-muted/80 overflow-hidden"
          aria-labelledby="about-argom-heading"
        >
          <div
            className="absolute inset-x-0 top-0 h-64 bg-gradient-to-b from-primary/15 to-transparent pointer-events-none"
            aria-hidden="true"
          />
          <div className="max-w-7xl mx-auto px-6 relative">
            <div className="text-center mb-14">
              <Badge className="mb-6 gradient-forest text-white px-5 py-2 rounded-full shadow-medium">
                Sobre a Argom
              </Badge>
              <h2
                id="about-argom-heading"
                className="text-4xl sm:text-5xl md:text-6xl font-bold text-foreground tracking-tight"
              >
                Uma plataforma criada para o campo brasileiro
              </h2>
              <p className="mt-6 text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Combinamos tecnologia, experiência agrícola e apoio local para
                entregar um sistema de gestão que fala a língua do produtor.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {storyHighlights.map((item, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="glass-card p-8 border-primary/10 hover:border-primary/30 transition-all duration-500"
                    style={{ animationDelay: `${index * 0.12}s` }}
                  >
                    <div
                      className={`inline-flex items-center justify-center w-14 h-14 rounded-3xl ${item.accent} mb-5 shadow-soft`}
                    >
        ...
        >
          <div
            className="absolute inset-0 gradient-primary opacity-[0.03]"
            aria-hidden="true"
          />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="animate-slide-in-left">
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Acesse todas as informações importantes em um só lugar. Tome
                  decisões inteligentes baseadas em dados precisos e em tempo
                  real.
                </p>
                ...
                <ul
                  ...
                  role="list"
                  aria-label="Benefícios do sistema"
                >
                  {benefits.map((benefit, index) => (
                    ...
                    >
                      <CheckCircle2
                        className="w-6 h-6 text-success flex-shrink-0 mt-1 group-hover:scale-125 transition-transform duration-300"
                        aria-hidden="true"
                      />
                ...
                >
                  Explorar Dashboard
                  <ChevronRight
                    className="w-5 h-5 ml-2 transition-transform group-hover:translate-x-2 duration-300"
                    aria-hidden="true"
                  />
                </Button>
              </div>
              ...
              <div className="relative animate-slide-in-right">
                <div
                  className="absolute inset-0 gradient-primary blur-3xl opacity-20 animate-pulse-gentle"
                  aria-hidden="true"
                />
                <figure className="relative group">
                  ...
                  />
                  <div
                    className="absolute inset-0 bg-gradient-to-t from-primary/20 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    aria-hidden="true"
                  />
                </figure>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <figure className="relative order-2 lg:order-1">
                <div
                  className="absolute inset-0 gradient-secondary blur-3xl opacity-20 animate-pulse-glow"
                  aria-hidden="true"
                />
                <img
              ...
              <div className="order-1 lg:order-2 animate-slide-in-right">
                ...
                <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                  Sistemas automatizados que aprendem e se adaptam às
                  necessidades específicas da sua propriedade, maximizando
          ...
          <div className="max-w-7xl mx-auto px-6">
            <header className="text-center mb-20">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Veja o que nossos clientes têm a dizer sobre a transformação em
                suas fazendas
              </p>
            </header>
        ...
        >
          <div
            className="absolute inset-0 gradient-sunset opacity-20"
            aria-hidden="true"
          />
          <div
            className="absolute inset-0 pattern-dots opacity-10"
            aria-hidden="true"
          />

          <div className="max-w-5xl mx-auto text-center px-6 relative">
            <div
              className="inline-block p-3 rounded-2xl bg-accent/10 mb-8 animate-float"
              aria-hidden="true"
            >
            ...
            <p className="text-2xl text-muted-foreground mb-12 leading-relaxed max-w-3xl mx-auto">
              Junte-se a milhares de produtores que já revolucionaram suas
              propriedades rurais com tecnologia de ponta e gestão inteligente.
            </p>
            ...
            <p className="text-muted-foreground mt-8">
              <span aria-label="Celebração">🎉</span> Teste grátis por 14 dias •
